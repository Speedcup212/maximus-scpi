/*
  # Mise à jour du trigger avec le prénom

  1. Modifications
    - Le trigger envoie maintenant le prénom au lieu du nom complet
    - Utilise le champ `prenom` pour le firstname de Sender.net
    - Plus cohérent avec les conventions d'emailing

  2. Logique
    - Utilise `prenom` si disponible
    - Sinon utilise `nom` en fallback
    - Sinon chaîne vide
*/
...
-- Créer la nouvelle fonction avec support du prénom
...
BEGIN
  ...
  -- Utilise prenom si disponible, sinon nom, sinon vide
