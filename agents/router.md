...
|---|---|---|
| Mots-clés, briefs articles, méta, maillage | 01 — SEO | `templates/seo-task.md` |
...
5. **Toute tâche est inscrite dans `tasks/backlog.md`** avant d'être exécutée.
...
```
AGENT ACTIVÉ : [00 à 05 ou Cursor]
...
VALIDATION REQUISE AVANT MODIFICATION : oui / non
```
