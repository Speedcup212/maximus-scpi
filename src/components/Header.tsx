...
const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className="bg-white dark:bg-gray-900 shadow-sm border-b border-gray-200 dark:border-gray-800 sticky top-0 z-[9999] backdrop-blur-sm bg-opacity-95 dark:bg-opacity-95 overflow-x-clip">
      <div className="max-w-7xl mx-auto w-full px-6 flex items-center h-16">
        {/* 1. BLOC GAUCHE : Logo */}
        <div className="flex-shrink-0">
          <button
            ...
            className="focus:outline-none focus:ring-2 focus:ring-green-500 rounded-lg transition-transform hover:scale-105 group py-2 cursor-pointer"
