...
export const ScpiOuOpciDifferencesAvantagesArticle: React.FC = () => {
  return (
    <div className="space-y-12">
      ...
      <section className="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-gray-800 dark:to-gray-900 rounded-2xl shadow-lg p-8 border border-blue-100 dark:border-gray-700">
        <nav className="mb-6">
          <ol className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
            ...
            <li>/</li>
            <li className="text-gray-900 dark:text-white font-semibold">SCPI ou OPCI : quelle différence et quel placement privilégier ?</li>
          </ol>
        </nav>
      ...
      <section className="bg-gradient-to-r from-blue-600 to-purple-700 dark:from-blue-800 dark:to-purple-900 rounded-2xl p-8 text-white">
        <h2 className="text-3xl font-bold mb-4">Conclusion : SCPI ou OPCI : quelle différence et quel placement privilégier ?</h2>
...
export default ScpiOuOpciDifferencesAvantagesArticle;
