...
export const SuccessionScpiTransmissionDroitsHeritageArticle: React.FC = () => {
  return (
    <div className="space-y-12">
      ...
      <section className="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-gray-800 dark:to-gray-900 rounded-2xl shadow-lg p-8 border border-blue-100 dark:border-gray-700">
        <nav className="mb-6">
          <ol className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
            ...
            <li>/</li>
            <li className="text-gray-900 dark:text-white font-semibold">Succession de SCPI : transmettre son patrimoine immobilier</li>
          </ol>
        </nav>
        ...
        <h1 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6 leading-tight">
          Succession de SCPI : transmettre son patrimoine immobilier
        </h1>
      ...
      <section className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 border border-gray-100 dark:border-gray-700">
        ...
        <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-6">
          Règles d'imposition complètes : IR, PS, IFI, succession. Barèmes 2025 et calculs détaillés. Pour succession scpi, cette analyse vous permet de comprendre tous les enjeux et d'optimiser votre stratégie d'investissement.
        </p>
      ...
      <section className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 border border-gray-100 dark:border-gray-700">
        ...
        <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-6">
          Stratégies d'optimisation fiscale selon votre TMI : AV, démembrement, SCPI EU. Pour succession scpi, cette analyse vous permet de comprendre tous les enjeux et d'optimiser votre stratégie d'investissement.
        </p>
      ...
      <section className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 border border-gray-100 dark:border-gray-700">
        ...
        <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-6">
          Simulations chiffrées pour TMI 11%, 30% et 41% avec toutes les enveloppes. Pour succession scpi, cette analyse vous permet de comprendre tous les enjeux et d'optimiser votre stratégie d'investissement.
        </p>
      ...
      <section className="bg-gradient-to-r from-blue-600 to-purple-700 dark:from-blue-800 dark:to-purple-900 rounded-2xl p-8 text-white">
        <h2 className="text-3xl font-bold mb-4">Conclusion : Succession de SCPI : transmettre son patrimoine immobilier</h2>
        <div className="space-y-4 text-lg text-blue-50">
          <p>
            En conclusion, succession scpi nécessite une analyse approfondie de votre situation : TMI, horizon d'investissement, objectifs patrimoniaux et appétence au risque.
          </p>
          <p>
...
export default SuccessionScpiTransmissionDroitsHeritageArticle;
