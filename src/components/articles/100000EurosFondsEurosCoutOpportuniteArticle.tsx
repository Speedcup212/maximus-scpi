...
export const Cent000EurosFondsEurosCoutOpportuniteArticle: React.FC = () => {
  return (
    <div className="space-y-12">
      ...
      <section className="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-gray-800 dark:to-gray-900 rounded-2xl shadow-lg p-8 border border-blue-100 dark:border-gray-700">
        <nav className="mb-6">
          <ol className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
            ...
            <li>/</li>
            <li className="text-gray-900 dark:text-white font-semibold">100 000 € sur un fonds euros : quel est le vrai coût d'opportunité ?</li>
          </ol>
        </nav>
        ...
        <div className="bg-gradient-to-r from-blue-50 to-cyan-50 dark:from-blue-900/20 dark:to-cyan-900/20 rounded-xl p-6 border-l-4 border-blue-500">
          ...
          <ul className="space-y-2 text-gray-800 dark:text-gray-200">
            ...
            <li className="flex items-start gap-2">
              ...
              <span>Analyse détaillée du fonctionnement de chaque solution, avec exemples concrets et tableaux comparatifs.</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-blue-600 font-bold mt-1">•</span>
              <span>Tableau comparatif complet : rendement, fiscalité, liquidité, frais, risques. Calculs chiffrés sur 10 et 20 ans.</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-blue-600 font-bold mt-1">•</span>
              <span>Trois profils types (TMI 11%, 30%, 41%) avec allocations optimales et résultats attendus.</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-blue-600 font-bold mt-1">•</span>
      ...
      <section className="bg-gradient-to-r from-blue-600 to-purple-700 dark:from-blue-800 dark:to-purple-900 rounded-2xl p-8 text-white">
        <h2 className="text-3xl font-bold mb-4">Conclusion : 100 000 € sur un fonds euros : quel est le vrai coût d'opportunité ?</h2>
...
export default Cent000EurosFondsEurosCoutOpportuniteArticle;
