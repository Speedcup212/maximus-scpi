        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="bg-green-50 dark:bg-green-900/20 p-3 rounded-lg text-center border border-green-200 dark:border-green-800">
              ...
              <div className="text-xs text-green-700 dark:text-green-300">Taux de distribution moyen historique</div>
            </div>
                ...
                >
                  <div className="flex-1">
                    ...
                    <div className="text-sm text-gray-600 dark:text-gray-300">
                      {rec.reason} • {rec.scpi.yield.toFixed(2)}% (taux distrib. historique)
                    </div>
                  </div>
          ...
          {/* Disclaimer CIF */}
          <DisclaimerBox className="mt-2" />
          <p className="text-xs text-gray-500 dark:text-gray-400 leading-relaxed mt-2">
            Cette pré-sélection est fournie à titre informatif et pédagogique. Elle ne constitue pas une recommandation personnalisée ni un conseil en investissement. Les SCPI présentent un risque de perte en capital, des revenus non garantis, une liquidité limitée et doivent être analysées selon votre situation patrimoniale.
          </p>
