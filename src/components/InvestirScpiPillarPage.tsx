    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 dark:from-gray-900 dark:to-gray-800">
      ...
      <div className="max-w-5xl mx-auto px-4 py-8">
        ...
        <article className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 mb-8">
          ...
          <div className="bg-blue-50 dark:bg-blue-900/20 rounded-xl p-6 border-l-4 border-blue-600">
            <p className="text-sm text-gray-800 dark:text-gray-200">
              <strong>💡 Besoin d'aide ?</strong> Consultez notre <a href="/comparateur-scpi" className="text-blue-600 hover:underline">comparateur de 63 SCPI</a> ou <button type="button" onClick={() => (window as any).openRdvModal?.()} className="text-blue-600 hover:underline">prenez rendez-vous</button> avec notre conseiller CIF.
            </p>
          </div>
        </article>
      </div>
