...
const exactPages: Record<string, string> = {
  ...
  'paref-evo': 'https://paref-gestion.com/nos-scpi/paref-evo/',
  'wemo-one': 'https://wemo-reim.fr/documents-et-bulletins/',
  'epargne-pierre': 'https://atland-voisin.com/scpi/epargne-pierre/',
